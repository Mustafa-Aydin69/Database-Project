...
class _FlightPricingScreenState extends State<FlightPricingScreen> {
  ...
  List<Map<String, dynamic>> _prices = [
    ...
    {
      'priceID': 3,
      'flight': 'PC202 - SAW → ADB',
      'flightClass': 'Economy',
      'price': 650.0,
    },
    {
      'priceID': 4,
      'flight': 'TK303 - IST → JFK',
      'flightClass': 'Economy',
      'price': 8500.0,
    },
    {
  ...
  List<Map<String, dynamic>> get _filteredPrices {
    return _prices.where((p) {
      final matchesSearch = p['flight'].toString().toLowerCase().contains(
        _searchTerm.toLowerCase(),
      );
      final matchesClass =
          _filterClass.isEmpty || p['flightClass'] == _filterClass;
  ...
  void _showPriceDialog({Map<String, dynamic>? priceData}) {
    ...
    showDialog(
      context: context,
      builder: (context) {
        // Okunabilirliği artırmak için bir değişken tanımlayalım
        final bool isEditing = priceData != null;
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: _flightOptions
                          ...
                          .toList(),
                      // Düzenleme modundaysa (isEditing true ise) null vererek kilitliyoruz.
                      // Değilse normal fonksiyonu çalıştırıyoruz.
                      onChanged: isEditing
                          ? null
                          : (val) => setState(() => _selectedFlight = val),
                      validator: (v) => v == null ? "Seçiniz" : null,
                      isExpanded: true,
                      // Pasifken gri görünmesini istemiyorsanız aşağıdaki satırı ekleyebilirsiniz (İsteğe bağlı):
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: _classOptions
                          ...
                          .toList(),
                      // Düzenleme modundaysa kilitliyoruz:
                      onChanged: isEditing
                          ? null
                  ...
                  setState(() {
                    if (isEditing) {
                      ...
                      final index = _prices.indexWhere(
                        (p) => p['priceID'] == priceData['priceID'],
                      );
                      _prices[index] = {
                        'priceID': priceData['priceID'],
                        'flight': _selectedFlight, // Mevcut değer korunur
                        'flightClass': _selectedClass, // Mevcut değer korunur
                        'price': double.parse(
              ...
              children: [
                const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      "Uçuş sınıflarına göre fiyat yönetimi",
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          decoration: const InputDecoration(
                            ...
                            hintText: "Tüm Sınıflar",
                          ),
                          items: [
                            const DropdownMenuItem(
                              value: "",
                              child: Text("Tüm Sınıflar"),
                            ),
                            ..._classOptions.map(
                              (c) => DropdownMenuItem(value: c, child: Text(c)),
                            ),
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _PriceCard(
                        ...
                        onEdit: () =>
                            _showPriceDialog(priceData: currentData[index]),
                        onDelete: () =>
                            _deletePrice(currentData[index]['priceID']),
                      );
                    },
                  );
                },
